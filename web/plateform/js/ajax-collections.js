tmcollection={list:function(){this.init=function(json){if(json==''){json='[]';}
...
$(document).ready(function () {
    ...
    $('.btn-product-collection').toggle(function () {
...
function DeleteProduct(id_collection,id_product,id_product_attribute){$.ajax({type:'GET',async:true,dataType:"json",url:mycollections_url,headers:{"cache-control":"no-cache"},cache:false,data:{myajax:1,action:'deleteproduct',id_collection:id_collection,id_product:id_product,id_product_attribute:id_product_attribute,},success:function(data){$('#collection_'+ id_collection+' .clp_'+ id_product+'_'+ id_product_attribute).hide();$('#clp_'+ id_product+'_'+ id_product_attribute).hide();}});}