        ...
        :
            {
                nb_column4,
                    nav;
            :
                total_product <= nb_column4 ? false : (( < ? php echo;
                $display_nav;
                    ?;
            >)
                    ? true : false;
        ...
        :
            {
                nb_column3,
                    nav;
            :
                total_product <= nb_column3 ? false : (( < ? php echo;
                $display_nav;
                    ?;
            >)
                    ? true : false;
        ...
        :
            {
                nb_column2,
                    nav;
            :
                total_product <= nb_column2 ? false : (( < ? php echo;
                $display_nav;
                    ?;
            >)
                    ? true : false;
        ...
        :
            {
                nb_column1,
                    nav;
            :
                total_product <= nb_column1 ? false : (( < ? php echo;
                $display_nav;
                    ?;
            >)
                    ? true : false;
        ...
        :
            {
                nb_column0,
                    nav;
            :
                total_product <= nb_column0 ? false : (( < ? php echo;
                $display_nav;
                    ?;
            >)
                    ? true : false;
