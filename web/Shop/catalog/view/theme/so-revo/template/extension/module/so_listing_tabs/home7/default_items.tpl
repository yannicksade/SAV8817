					...
					<div class="product-item-container"> 
						...
						<?php  if($display_add_to_cart || $display_wishlist || $display_compare){?>
							...
							<?php if($display_wishlist){?>
								<button class="wishlist btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o"></i></button>
							<?php } ?>
