...
class CommunicationControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm_user_communication');
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm_user_communication/'), 'The response is redirect not to /apm_user_communication/');
