...
class ConseillerControllerTest extends WebTestCase
{
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm/marketing_conseiller');
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm/marketing_conseiller/'), 'The response is redirect not to /apm_marketing_conseiller');
