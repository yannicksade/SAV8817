...
class QuotaControllerTest extends WebTestCase
{
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm_marketing_quota');
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm_marketing_quota/'), 'The response is redirect not to /apm_marketing_quota');
