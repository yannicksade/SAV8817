...
class Specification_achatControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm_achat_specification_achat');
        $crawler = $client->followRedirect();
        $this->assertEquals(200, $client->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /apm_achat_specification_index/");
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm_achat_specification_achat/'), 'The response is redirect not to /apm_achat_groupe_index');
