...
class TransactionControllerTest extends WebTestCase
{
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm/vente_transaction');
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm/vente_transaction/'), 'The response is redirect not to /apm_vente_transaction/');
