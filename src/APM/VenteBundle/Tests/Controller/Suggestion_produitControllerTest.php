...
class Suggestion_produitControllerTest extends WebTestCase
{
    public function testCompleteScenario()
    {
        ...
        $client->request('GET', '/apm/vente_suggestion_offre');
        ...
        $this->assertTrue($client->getResponse()->isRedirect('/apm/vente_suggestion_offre/'), 'The response is redirect not to /apm_vente_suggestion_offre/');
